...
pub fn build(b: *std.Build) void {
    ...
    const basic_shader = zitrus.AssemblePsm.init(zitrus_dep, .{
        .name = "basic.psh",
        .root_source_file = b.path("assets/basic.psm"),
    });

    exe.root_module.addAnonymousImport("basic.psh", .{ .root_source_file = basic_shader.out });
