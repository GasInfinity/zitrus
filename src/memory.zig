...
pub const config11_begin: u32 = io_begin + 0x140000;
pub const config11: *volatile zitrus.hardware.config.@"11" = @ptrFromInt(config11_begin);
...
pub const gpio_begin: u32 = io_begin + 0x147000;
pub const gpio: *volatile zitrus.hardware.gpio.Registers = @ptrFromInt(gpio_begin);
