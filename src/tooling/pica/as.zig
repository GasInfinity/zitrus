...
const TemporaryRegister = pica.TemporaryRegister;
const SourceRegister = pica.SourceRegister;
const DestinationRegister = pica.DestinationRegister;
const BooleanRegister = pica.IntegralRegister.BooleanRegister;
const IntegerRegister = pica.IntegralRegister.IntegerRegister;
