...
pub fn jumpToHome(app: *Application, apt: Applet, service: Applet.Service, srv: ServiceManager, capture: Gpu.ScreenCapture, params: Applet.JumpToHomeParameters) !ExecutionResult {
...
pub fn startLibraryApplet(app: *Application, apt: Applet, service: Applet.Service, srv: ServiceManager, capture: Gpu.ScreenCapture, app_id: Applet.AppId, param_handle: Object, param: []const u8) !void {
    const last_allow_sleep = app.flags.allow_sleep;
...
pub fn launchSystemApplet(app: *Application, apt: Applet, service: Applet.Service, srv: ServiceManager, capture: Gpu.ScreenCapture, app_id: Applet.AppId, param_handle: Object, param: []const u8) !ExecutionResult {
    const last_allow_sleep = app.flags.allow_sleep;
...
pub fn screenTransfer(app: *Application, apt: Applet, service: Applet.Service, srv: ServiceManager, capture: Gpu.ScreenCapture, target_app_id: Applet.AppId, copy_framebuffers: bool) !void {
