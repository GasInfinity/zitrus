...
pub fn startContext(swkbd: *SoftwareKeyboard, app: *Application, apt: Applet, service: Applet.Service, srv: ServiceManager, capture: Gpu.ScreenCapture, context: anytype) !Result {
...
pub fn start(swkbd: *SoftwareKeyboard, app: *Application, apt: Applet, service: Applet.Service, srv: ServiceManager, capture: Gpu.ScreenCapture) !Result {
